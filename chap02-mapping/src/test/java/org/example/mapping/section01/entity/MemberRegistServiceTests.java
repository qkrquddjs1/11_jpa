...
public class MemberRegistServiceTests {
    ...
    @Autowired
    private MemberRegistService memberRegistSrvice;
    ...
    void testCreateTable(
        ...
        Assertions.assertDoesNotThrow(
                () -> memberRegistSrvice.registMember(newMember)
        );
    }
    ...
    void testAccessProperty(
        ...
        //when
        String registedName = memberRegistSrvice.registMemberAndFindName(newMember);
